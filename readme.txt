...
<br>
<strong>Blogers, self-webmasters, average users</strong>: This is not right tools for you. <a href="contacts.html">Contact me</a>, I can create anything what you will need, but leave this plugin away. It can (and will) destroy your site within seconds. No joke...<br>
<br>
...
<br>
<strong>Gurus</strong>: It countain 3 tools. First allows to see environment variables and PHP init settings (yes, most images in admin panel gone at this page, np). Second allows direct communication with database, think about "mysql" command line tool. It is very light phpMyAdmin. Third is terminal-like tool, allowing command row, almost like SSH, but restricted to HTTPD user rights and no way to run continuous tasks like "top".</p>
